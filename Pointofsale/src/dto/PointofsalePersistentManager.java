...
public class PointofsalePersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Pointofsale";
	...
	private PointofsalePersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(dto.Staff.class);
		configuration.addAnnotatedClass(dto.Invoice.class);
		configuration.addAnnotatedClass(dto.Line.class);
		configuration.addAnnotatedClass(dto.Product.class);
		configuration.addAnnotatedClass(dto.Payment.class);
		configuration.addAnnotatedClass(dto.Payment_Method.class);
		configuration.addAnnotatedClass(dto.Catagory.class);
		configuration.addAnnotatedClass(dto.Staff_Type.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new PointofsalePersistentManager();
		}
